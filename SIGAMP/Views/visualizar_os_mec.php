...
<br><br>
<p align="right"><a href="../Models/finalizando_os_mec.php?id=<?=$relatorio['SERVICO_cd_servico']?>"><button class="btn btn-success">Dar Baixa</button></a></p>
<a href="mecanico.php">Voltar a lista de Ordens</a>
<?php
